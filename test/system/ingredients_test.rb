...
class IngredientsTest < ApplicationSystemTestCase
  ...
  test "should create ingredient" do
    ...
    fill_in "Ingr name", with: @ingredient.ingr_name
    fill_in "Test field1", with: @ingredient.test_field1
    fill_in "Test field2", with: @ingredient.test_field2
    fill_in "Test field3", with: @ingredient.test_field3
